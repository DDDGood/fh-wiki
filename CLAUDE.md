...
4. **盡可能保留細節**：凡是 wiki 目前**沒有寫到**的數據、設定範圍、原理說明、社群梗、UI 怪癖一律補上，主題重疊**不是**拒收理由。**唯一例外**是作者本人明確聲明已過時的部分（例如「這數值是舊版的」「這個流派現在沒人用」）。由 `knowledge-curator` 做差異審查，重點是找出新增資訊而非剔除重疊。
